 ...
 * created 05/31/2016
 */
'use strict';Date.now||(Date.now=function(){return(new Date).getTime()});exists(window.Game)||(Game={});
...
function(b,a){var e=this.getVisibleRect(),g,f=this.context;f.clearRect(0,0,e.width(),e.height());var h=b.getGameEventsListener();h&&h.onRenderStart&&(f.save(),h.onRenderStart(b,f));var l=d.LAYER_MIN-1;for(f.save();l++<d.LAYER_MAX;){g=a.filter(GameObject.renderLayerFilter.bind(void 0,l));for(var k=g.length;k--;)g[k].isOutOfMap(e)||g[k].render(f);if(this.debug){for(k=g.length;k--;)g[k].isOutOfMap(e)||g[k].renderDebug(f);l==d.LAYER_BG3&&this.renderDebug(f)}}f.restore();(g=this.getHud())&&!g.getContext()&&
...
Game.objects.Object=function(){GameObject=function(){};GameObject.prototype.onFrame=function(a,b){this.moveOnFrame(a,b);this.accelerateOnFrame(a,b);this.rotateOnFrame(a,b);this.mustKeepInRect()&&this.maintainInRect(a.gameMap.getVisibleRect())};GameObject.prototype.moveOnFrame=function(a,b){(a=this.getSpeed())&&!a.isZero()&&this.move(a.clone().mul(b))};GameObject.prototype.accelerateOnFrame=function(a,b){(a=this.getAcceleration())&&!a.isZero()&&this.accelerate(a.clone().mul(b))};GameObject.prototype.rotateOnFrame=function(a,
b){(a=this.getRotationSpeed())&&this.rotate(a*b)};GameObject.prototype.setRotationFieldEnabled=function(a){a&&!this.radians?this.radians=0:!a&&exists(this.radians)&&delete this.radians;return this};GameObject.prototype.rotate=function(a){exists(this.radians)&&(this.radians=(this.radians+a)%(2*Math.PI));this.renderer&&this.renderer.rotate(a);this.collider&&this.collider.rotate(a);return this};GameObject.prototype.setRadians=function(a){typeof a!=TYPE_NUMBER?console.log("cannot set radians to "+a):
(exists(this.radians)||this.setRotationFieldEnabled(!0),this.rotate(a-this.radians))};GameObject.prototype.getRadians=function(){return this.radians||0};GameObject.prototype.getDirection=function(){return Vec2.createFromRadians(this.getRadians())};GameObject.prototype.lookAt=function(a){exists(this.radians)||this.setRotationFieldEnabled(!0);a=Vec2.translation(this.getPosition(),a);this.setRadians(a.getAngle());return this};GameObject.prototype.setRotationSpeed=function(a){a?this.rotationSpeed=a:this.rotationSpeed&&
delete this.rotationSpeed;return this};GameObject.prototype.getRotationSpeed=function(){return this.rotationSpeed||0};GameObject.prototype.grow=function(a){this.renderer&&this.renderer.grow(a);this.collider&&this.collider.grow(a);return this};GameObject.prototype.setRenderer=function(a){this.renderer=a;return this};GameObject.prototype.getRenderer=function(){return this.renderer};GameObject.prototype.render=function(a){this.renderer&&this.renderer.render(this.getPosition(),a)};GameObject.prototype.renderDebug=
function(a){this.collider&&this.collider.render(this.getPosition(),a)};GameObject.prototype.renderMouseOver=function(a,b,e,d){!e.running&&d&&(b=this.getRect(),a.fillStyle="#fff",a.font="15px Verdana",d=this.getInformations(),e=e.getMap().getVisibleRect(),e.right-b.right<b.left-e.left?(b.right=b.left,b.left=e.left,e=Gravity.RIGHT):(b.left=b.right,b.right=e.right,e=Gravity.LEFT),a.wrapText(d.join("\n"),b,15,e,!0,!1));a.strokeStyle="#fff";(new Circle(this.getPosition(),1.1*this.getRenderRadius())).draw(a,
!1,!0)};GameObject.prototype.getInformations=function(){var a=this.getPosition(),b=this.getSpeed(),e=this.getAcceleration(),d=[];a&&d.push(["p :",a.roundedVec(4)].join(" "));b&&d.push(["s :",b.roundedVec(4)].join(" "));e&&d.push(["a :",e.roundedVec(4)].join(" "));return d};GameObject.prototype.getContextMenu=function(){return""};GameObject.prototype.renderLayer=Game.Map.LAYER_OBJ1;GameObject.renderLayerFilter=function(a,b){return b.renderLayer==a};GameObject.prototype.setCollider=function(a){this.collider=
a;return this};GameObject.prototype.getCollider=function(){return this.collider};GameObject.prototype.canCollide=function(){return!isNull(this.getCollider())};GameObject.prototype.prepareCollision=function(){this.collision||(this.collision={});this.collision.position=this.getPosition();this.collision.collider=this.getCollider();this.collision.collider.prepareCollision(this.collision)};GameObject.prototype.finishCollision=function(){this.collision.collider.finishCollision()};GameObject.prototype.collides=
function(a){return this.collision.position&&a.collision.position&&this.collision.collider.collides(this.collision,a.collision)};GameObject.prototype.onCollision=function(a,b){};GameObject.COLLISION_LAYER=1;GameObject.prototype.collisionLayers=[GameObject.COLLISION_LAYER];GameObject.prototype.isInLayer=function(a){return 0<=this.collisionLayers.indexOf(a)};var d=function(a,b,e){for(e=e.collisionLayers;b--&&-1==e.indexOf(a[b]););return 0<=b},b=function(a,b,e){for(e=e.collisionLayers;b--&&-1==e.indexOf(a[b]););
return-1==b},a=function(a,b){return 0<=b.collisionLayers.indexOf(a)},e=function(a,b){return-1==b.collisionLayers.indexOf(a)};GameObject.getCollisionLayerFilter=function(g,f){var h=g.length;return 1<h?f?d.bind(null,g,h):b.bind(null,g,h):h?f?a.bind(null,g[0]):e.bind(null,g[0]):function(a){return!f}};GameObject.NO_COLLISION_LAYER=-1;GameObject.collisionFilter=GameObject.getCollisionLayerFilter([-1],!1);GameObject.prototype.getRect=function(){return Rect.getUnion([this.getRenderRect(),this.getColliderRect()])};
GameObject.prototype.getColliderRect=function(){var a=this.getCollider();return a?a.getRect(this.getPosition()):Rect.createFromPoint(this.getPosition())};GameObject.prototype.getRenderRect=function(){var a=this.getRenderer();return a?a.getRect(this.getPosition()):Rect.createFromPoint(this.getPosition())};GameObject.prototype.getRadius=function(){return Math.max(this.getRenderRadius(),this.getColliderRadius())};GameObject.prototype.getRenderRadius=function(){var a=this.getRenderer();return a?a.getRadius():
0};GameObject.prototype.getColliderRadius=function(){var a=this.getCollider();return a?a.getRadius():0};GameObject.prototype.getCircle=function(){return new Circle(this.getPosition(),this.getRadius())};GameObject.prototype.getRenderCircle=function(){return new Circle(this.getPosition(),this.getRenderRadius())};GameObject.prototype.getColliderCircle=function(){return new Circle(this.getPosition(),this.getColliderRadius())};GameObject.prototype.getPosition=function(){return this.position};GameObject.prototype.getSpeed=
function(){return this.speed};GameObject.prototype.getAcceleration=function(){return this.accel};GameObject.prototype.copyPosition=function(){return this.getPosition().clone()};GameObject.prototype.copySpeed=function(){return this.getSpeed().clone()};GameObject.prototype.copyAcceleration=function(){return this.getAcceleration().clone()};GameObject.prototype.setPositionXY=function(a,b){var e=this.getPosition();e?e.setXY(a,b):this.position=new Vec2(a,b);return this};GameObject.prototype.setPosition=
...
this.getMaxEnergy()};d.prototype.setEnergyRecoverSpeed=function(a){this.energyRecoverSpeed=a};d.prototype.getMaxEnergy=function(){return this.maxEnergy};d.prototype.getEnergy=function(){return this.energy};d.prototype.getEnergyRecoverSpeed=function(){return this.energyRecoverSpeed};var b=override(d,"onFrame",function(a,e){b.call(this,a,e);(a=this.getEnergyRecoverSpeed())&&!this.isEnergyFull()&&this.recoverEnergy(a*e)}),a=override(d,"getInformations",function(){var b=a.call(this);b.push(["energy :",
...
Game.objects.properties.Homing={getSteeringForce:function(d,b,a,e,g){return Vec2.translation(d,g).normalize().mul(b).remove(e).clampMagnitude(0,a)},applyOnClass:function(d,b,a,e){var g=override(d,"onFrame",function(a,b){if(this.getTarget){var e=this.getTarget(a);if(e){e instanceof Game.objects.Object&&(e=e.getPosition());var d=this.getPosition(),n=Vec2.translation(d,e),m=n.magnitude(),r=this.getMaxSpeed(m),q=this.getSteerForce(r,m),n=n.mul(q/m);n.add(Game.objects.properties.Homing.getSteeringForce(d,
r,q,this.getSpeed(),e)).normalize().mul(q);this.setAcceleration(n);g.call(this,a,b);this.setSpeed(this.getSpeed().clampMagnitude(0,r))}else this.setAcceleration(Vec2.ZERO),g.call(this,a,b)}else g.call(this,a,b)});isNull(e)||(d.prototype.getTarget=e);isNull(b)?d.prototype.getMaxSpeed=function(a){return 200}:d.prototype.getMaxSpeed=function(a){return b};isNull(a)?d.prototype.getSteerForce=function(a,b){return 100}:d.prototype.getSteerForce=function(b,e){return a}},applyOnObject:function(d,b,a,e){var g=
d.onFrame;d.onFrame=function(d,h){var l=e(d);if(isNull(l))this.setAcceleration(Vec2.ZERO);else{console.log(l);l instanceof Game.objects.Object&&(l=l.getPosition());var k=this.getPosition(),n=Vec2.translation(k,l).normalize().mul(steer);n.add(Homing.getSteeringForce(k,this.getSpeed(),b,a,this.getSpeed(),l));this.setAcceleration(n)}g.call(this,d,h)}}};
...
Game.Map.LAYER_NONE;a.prototype.canCollide=function(a){return!1};a.prototype.createParticle=function(a,b,e,d){p=this.particleGenerator(a,b,e,d);d?(a=Vec2.createFromRadians(e),this.emitDistance&&p.move(a.clone().mul(this.emitDistance)),p.speed=a.mul(d)):this.emitDistance&&p.move(Vec2.createFromRadians(e).mul(this.emitDistance));return p};a.prototype.createParticles=function(a){for(var b,e,d,g=this.getPosition(),m=Array(a);a--;)b=this.maxLifeTime==this.minLifeTime?this.minLifeTime:Math.random()*(this.maxLifeTime-
this.minLifeTime)+this.minLifeTime,e=this.maxSpeed==this.minSpeed?this.minSpeed:Math.random()*(this.maxSpeed-this.minSpeed)+this.minSpeed,d=this.maxAngle==this.minAngle?this.minAngle:Math.random()*(this.maxAngle-this.minAngle)+this.minAngle,m[a]=this.createParticle(b,g,d,e);return m};a.prototype.onFinished=function(a){this.kill(a)};var g=override(a,"onFrame",function(a,b){g.call(this,a,b);var e=this.emitedParticles.length,d=Math.max(0,1-this.speedDampFactor*b),n=Math.max(0,1-this.reduceSizeFactor*
b);if(e){for(var m=e;m--;)0>=this.emitedParticles[m].lifeTime?this.emitedParticles.splice(m,1):(this.emitedParticles[m].speed&&1!==d&&this.emitedParticles[m].speed.mul(d),1!==n&&this.emitedParticles[m].grow(n));if(this.particlePositionRelative&&this.speed&&!this.speed.isZero())for(d=this.speed.clone().mul(b),m=e;m--;)this.emitedParticles[m].shape.move(d)}else if(this.max&&this.emited>=this.max)this.onFinished(a);-1<this.emited&&(!this.max||this.emited<this.max)&&(b=this.emited+b*this.rate,this.max&&
b>this.max&&(b=this.max),e=this.createParticles(Math.floor(b-Math.floor(this.emited))),this.emited=b,Array.prototype.push.apply(this.emitedParticles,e),a.addObjects_noCheck(e))});return a}();d.Explosion=function(){var b=d.Emitor,a=function(a){b.call(this,1E3*a,a)};classExtend(b,a);a.prototype.minLifeTime=.1;a.prototype.maxLifeTime=.5;a.prototype.minSpeed=500;a.prototype.maxSpeed=1500;a.prototype.speedDampFactor=2;a.prototype.reduceSizeFactor=3;return a}();d.TraceDrawer=function(){TraceDrawer=function(b,
a){this.lifeTime=b;this.color=a};TraceDrawer.prototype.applyOnObject=function(b,a){var e=a.setPositionXY,d=this;a.setPositionXY=function(f,h){var l=a.copyPosition();e.call(this,f,h);f=a.getPosition();if(!l.equals(f))d.onMove(b,l,f)}};TraceDrawer.applyOnClass=function(b){var a=b.prototype.moveOnFrame;b.prototype.moveOnFrame=function(b,d){if(this.traceDrawer){var f=this.copyPosition();a.call(this,b,d);d=this.getPosition();if(!f.equals(d))this.traceDrawer.onMove(b,f,d)}else a.call(this,b,d)}};TraceDrawer.prototype.onMove=
function(b,a,e){a=this.getParticlesForTranslation(a,e);if(a.length)for(e=0;e<a.length;e++)b.addObject(a[e]);else b.addObject(a)};TraceDrawer.prototype.getParticlesForTranslation=function(b,a){return new d.Stroked(this.lifeTime,new Line(b,a),this.color)};return TraceDrawer}();return d}();Game.objects.bullets=function(){var d={},b=function(){var a=Game.objects.Object.Static,b=function(b,e,d,g){a.call(this,e);exists(d)&&(this.speed=d.clone());this.damages=b;isNull(g)||(this.lifeTime=g)};classExtend(a,b);Game.objects.particles.TraceDrawer.applyOnClass(b);Game.objects.properties.LifeTime.applyOnClass(b);b.defaultTraceDrawer=new TraceDrawer(.05,"#FF0000");b.defaultShape=new Polygon(Vec2.createVec2Array([-10,2,5,2,7,1,8,0,7,1,5,-2,-10,-2]));b.prototype.setLauncher=function(a){this.launcher=
...
b.prototype.onCollision=function(a,b){this.launcher!=b&&0!==this.damages&&(b.receiveDamages&&b.receiveDamages(a,this,this.damages)&&(this.damages=0),this.kill(a))};b.createBullet=function(a,d,g,f,m){a=new b(a,d,g);f=f.clone();f.rotate(g.getAngle());a.renderer=new GameObjectRenderer.Shaped(f.clone(),m);a.collider=new b.Collider(f);a.explosion=new ParticleEmitor.Explosion(20);a.traceDrawer=b.defaultTraceDrawer;return a};b.prototype.renderLayer=Game.Map.LAYER_OBJ3;getInfo=override(b,"getInformations",
...
this.radians)%(2*Math.PI),angle>Math.PI&&(angle=2*Math.PI-angle),angle<d&&(d=angle,b=a[g]));return isNull(b)?null:b.getPosition()};var l=override(g,"onFrame",function(a,b){l.call(this,a,b);this.setRadians(this.getSpeed().getAngle())});return g}();d.Homing=b;d.Homing.prototype=b.prototype;return d}();Game.objects.interactives=function(){var d={};d.obstacles=function(){var b={};b.Obstacle=function(){var a=Game.objects.Object.Static,b=function(b){a.call(this,b)};classExtend(a,b);b.prototype.onCollision=function(a,b){};b.prototype.repulse=function(a,b){a.move(b);var d=a.copySpeed();b=b.getAngle();d.rotate(-b);d.x=0;d.rotate(b);a.setSpeed(d)};b.COLLISION_LAYER=0;b.prototype.collisionLayers=[b.COLLISION_LAYER];b.prototype.renderLayer=Game.Map.OBJ1;return b}();b.Rectangular=function(){var a=b.Obstacle,
d=function(b){a.call(this,b)};classExtend(a,d);d.prototype.disableBelow=function(a){this.enableBelowCross=a};d.prototype.disableAbove=function(a){this.enableAboveCross=a};d.prototype.disableLeft=function(a){this.enableLeftCross=a};d.prototype.disableRight=function(a){this.enableRightCross=a};d.prototype.onCollision=function(a,b){a=this.getRadians();var d,e,k=b.getPosition();d=this.getPosition();var n=b.getSpeed();0!==a&&(this.getCollider().rotate(-a),b.getCollider().rotate(-a),k=Vec2.translation(d,
k).rotate(-a).add(d),n=n.clone().rotate(-a));d=b.getCollider().getRect(k);e=this.getCollider().getRect();var m=Vec2.zero();!this.enableAboveCross&&e.below(k)&&-.01<=n.y?m.y=e.top-d.bottom:!this.enableBelowCross&&e.above(k)&&.01>=n.y&&(m.y=e.bottom-d.top);!this.enableRightCross&&e.onLeftOf(k)&&.01>=n.x?m.x=e.right-d.left:!this.enableLeftCross&&e.onRightOf(k)&&-.01<=n.x&&(m.x=e.left-d.right);0!==a&&(this.getCollider().rotate(a),b.getCollider().rotate(a),m.rotate(a));m.isZero()||this.repulse(b,m)};return d}();
b.Circular=function(){var a=b.Obstacle,d=function(b){a.call(this,b)};classExtend(a,d);d.prototype.onCollision=function(a,b){var d=this.getPosition(),e=b.getPosition(),k=Vec2.translation(d,e);a=k.getAngle();var n=d.x+this.getCollider().getRadius(),m=b.getSpeed();0!==a&&(b.getCollider().rotate(-a),e=k.rotate(-a).add(d),m=m.clone().rotate(-a));0>=m.x?(d=b.getCollider().getRect(e),n=new Vec2(n-d.left,0),0!==a&&(b.getCollider().rotate(a),n.rotate(a)),n.isZero()||this.repulse(b,n)):0!==a&&b.getCollider().rotate(a)};
return d}();b.properties={Bumper:{applyOnObstacle:function(a,b){var d=a.repulse;a.repulse=function(a,b){var e=a.copySpeed();d.call(this,a,b);b=b.getAngle();e.rotate(-b);e.x=-e.x*this.getBumperStrength();40<Math.abs(e.x)&&(e.rotate(b),a.setSpeed(e))};a.setBumperStrength=function(a){this.bumperStrength=a};a.getBumperStrength=function(){return this.bumperStrength};exists(b)&&a.setBumperStrength(b)},applyOnObstacleClass:function(a,b){var d=override(a,"repulse",function(a,b){var e=a.copySpeed();d.call(this,
a,b);b=b.getAngle();e.rotate(-b);e.x=-e.x*this.getBumperStrength();40<Math.abs(e.x)&&(e.rotate(b),a.setSpeed(e))});a.prototype.setBumperStrength=function(a){this.bumperStrength=a};a.prototype.getBumperStrength=function(){return this.bumperStrength};exists(b)&&(a.prototype.bumperStrength=b)}}};return b}();return d}();Game.weapons=function(){var d={};d.Weapon=function(){var b=function(a,b){this.damages=a;isNull(b)||this.setOwner(b)};b.prototype.use=function(a,b,d){};b.prototype.setOwner=function(a){this.owner=a};b.prototype.getOwner=function(){return this.owner};b.prototype.getDamages=function(){return this.damages};b.prototype.setDamages=function(a){this.damages=a};b.prototype.onDeath=function(){delete this.damages;this.owner&&delete this.owner};b.prototype.clone=function(){return new b(this.damages,null)};b.applyOnClass=
...
d.trace);isNull(d.explosionSize)||(a.explosion=new Game.objects.particles.Explosion(d.explosionSize));return a}};a.createLaserBulletGenerator=function(a,b,d){var e;e=exists(d)?new Line(Vec2.ZERO,new Vec2(d,0)):new Ray(Vec2.ZERO,0);return function(b,f,m){d&&(f=Vec2.createFromRadians(m).mul(d/2).add(f));b=new Game.objects.bullets.Bullet(b,f,Vec2.ZERO,.01);b.renderer=new Game.objects.renderers.Shaped(e,a);b.renderer.fill=!1;b.renderer.stroke=!0;b.collider=new Game.objects.colliders.Shaped(e);b.rotate(m);
...
applyFriction:function(b){var a=b.getSpeed();a&&!a.isZero()&&d.applyForce(b,a.clone().mul(friction))},applySpaceGravity:function(b,a){var e=a.mass|1,g=b.mass|1;a=Vec2.translation(b,a);e=d.G*e*g/a.squareMagnitude();d.applyForce(b,a.normalize().mul(e))}};return d}();Game.hud={};
...
2,a.strokeStyle="#fff",d.draw(a,this.fill,!0),a.lineWidth/=2);a.strokeStyle=this.getTextColor();b=this.getFontSize();a.font=[b,"px ",this.getFont()].concat();a.wrapText(this.getText(),d,1.25*b,Gravity.CENTER,!1,!0)};return b}();
...
Game.hud.views.ProgressBar=function(){var d=Game.hud.views.View,b=function(a,b,g,f,h){d.call(this,a);this.needFillUpdate=this.needStrokeUpdate=!0;this.setWidth(b);this.setHeight(g);this.setMax(f);this.setValue(h);this.setMargins(0,0);this.setGravity(Gravity.LEFT|Gravity.TOP);this.setColor("#f00")};classExtend(d,b);b.prototype.createShape=function(a,b){a=a?this.getWidth():this.getWidth()/this.getMax()*this.getValue();var d=this.getHeight(),f=this.getGravity(),h=NaN,l=NaN,k=NaN,n=NaN;(f&Gravity.RIGHT)===
Gravity.RIGHT?n=b.right-this.getMarginX():h=(f&Gravity.LEFT)===Gravity.LEFT||(f&Gravity.CENTER)!==Gravity.CENTER?b.left+this.getMarginX():b.left+(canvasrect.width()-a)/2;(f&Gravity.BOTTTOM)===Gravity.BOTTOM?k=b.bottom-this.getMarginY():l=(f&Gravity.TOP)===Gravity.TOP||(f&Gravity.CENTER)!==Gravity.CENTER?b.top+this.getMarginY():b.top+(b.height()-d)/2;isNaN(h)?h=n-a:isNaN(n)&&(n=h+a);isNaN(l)?l=k-d:isNaN(k)&&(k=l+d);return(new Rect(h,l,n,k)).getShape()};b.prototype.setGravity=function(a){this.gravity=
...
b.prototype.containsPoint=function(a){var b=this.getStrokeShape();return!isNull(b)&&b.contains(a)};b.prototype.render=function(a,b){var d=this.getStrokeShape(b);b=this.getFillShape(b);var f=this.getColor();a.fillStyle=f;b.draw(a,!0,!1);this.getState()&Game.hud.views.STATE.OVERED?(a.lineWidth*=2,a.strokeStyle="#fff",d.draw(a,!1,!0),a.lineWidth/=2):(a.strokeStyle=f,d.draw(a,!1,!0))};return b}();
...
Game.turn.Manager=function(){var d=function(b){this.objects=b||[];this.lastIndex=-2;this.running=this.inObjectTurn=!1;this.turnListener=null};d.prototype.setTurnListener=function(b){this.turnListener=b};d.prototype.getTurnListener=function(){return this.turnListener};d.prototype.setObjects=function(b){if(-1!=this.lastIndex){var a=this.getObjectAt(this.lastIndex);this.objects=b;this.lastIndex=this.getObjectIndex(a)}else this.objects=b};d.prototype.getObjects=function(){return this.objects};d.prototype.getObjectAt=
function(b){return this.objects[b]};d.prototype.getObjectIndex=function(b){return this.objects.indexOf(b)};d.prototype.getCurrentObject=function(){return this.objects[this.lastIndex]};d.prototype.addObject=function(b){this.addObjectAt(this.objects.length)};d.prototype.addObjectAt=function(b,a){a<=this.lastIndex&&this.lastIndex++;this.objects.splice(a,0,b)};d.prototype.removeObject=function(b){this.removeObjectAt(this.getObjectIndex(b))};d.prototype.removeObjectAt=function(b){b<=this.lastIndex&&this.lastIndex--;
this.objects.splice(b,1)};d.prototype.onFrame=function(b,a){if(this.running&&!this.inObjectTurn){if(-2==this.lastIndex){if(this.turnListener)this.turnListener.onTurnBegin(b,this);this.lastIndex=0}else this.lastIndex++;if(this.lastIndex<this.objects.length){if(a=this.getObjectAt(this.lastIndex)){if(this.turnListener)this.turnListener.onObjectTurnBegin(b,this,a,this.lastIndex);a.onTurn(b,this);this.inObjectTurn=!0}}else{if(this.turnListener)this.turnListener.onTurnEnd(b,this);this.lastIndex=-2}}};d.prototype.onObjectTurnEnd=
function(b){this.inObjectTurn=!1;if(this.turnListener)this.turnListener.onObjectTurnEnd(b,this,this.getObjectAt(this.lastIndex),this.lastIndex)};d.prototype.stop=function(){this.running=!1};d.prototype.start=function(){this.running=!0};d.prototype.isRunning=function(){return this.running};d.prototype.isInObjectTurn=function(){return this.inObjectTurn};d.turnObjectFilter=function(b){return b.onTurn};d.getTurnObjects=function(b){return b.getObjects(d.turnObjectFilter)};return d}();
